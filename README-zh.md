# ChatDev 2.0 - DevAll
个人全栈开发 AI Agent 系统（基于 ChatDev 适配优化）
本分支基于 ChatDev 2.0（DevAll）零代码多 Agent 编排平台，结合 Cursor 与 Aider 工具链，构建了一套面向个人开发者的 AI 辅助全栈开发 Agent 系统，深度适配个人开发者全链路开发需求。
项目核心定位
针对个人开发者在全栈项目开发中面临的技术栈跨度大、重复编码工作冗余、调试排错效率低、长上下文代码理解能力不足等核心痛点，本项目基于 ChatDev 原生的多 Agent 协同、可视化工作流编排能力，优化打造了单 Agent 多工具调用的轻量化架构，打通了从需求到落地的全栈开发闭环。
核心架构与能力
系统采用「单 Agent + 多工具联动」的轻量化架构，原生兼容 ChatDev 的工作流配置体系，完整实现开发需求→技术栈选型→模块化代码生成→自动化语法校验→安全漏洞扫描→问题定位→代码迭代优化的全链路闭环，核心能力包括：
• 长上下文代码理解与多文件联动修改，适配全栈项目跨模块开发需求
• 多工具原生调用，无缝对接 Cursor、Aider 等主流 AI 开发工具链
• 第三方库自动适配与依赖管理，降低多技术栈开发门槛
• 自动化单元测试生成与代码合规校验，保障项目交付质量
项目落地成果
目前本系统已完成 3 个个人全栈项目的完整开发落地，覆盖前端可视化、后端接口开发、全栈小工具开发等场景，核心落地数据如下：
• 单项目平均完成 20 + 轮对话交互与迭代优化
• 单项目全流程 Token 消耗量超 2000 万
• 累计将个人全栈项目开发周期缩短 60%
• 代码调试排错耗时减少 70%，大幅降低个人开发的时间成本
MiMo 大模型适配计划
本项目后续将深度适配小米 MiMo-V2.5 系列大模型，依托 MiMo 大模型 128K 超长上下文窗口、精准多轮工具调用、中文语义深度理解、多语言代码生成等核心能力，进一步优化系统在长代码场景的理解与生成效果，完善全链路开发闭环能力。
本次申请小米 MiMo 大模型百万亿 Token 激励计划额度，将核心用于本项目的 MiMo 模型适配调试、全场景功能迭代、长链路推理压力测试与多项目落地验证，持续优化面向个人开发者的全栈开发 Agent 体验。
<p align="center">
